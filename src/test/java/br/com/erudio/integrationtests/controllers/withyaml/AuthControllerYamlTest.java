...
public class AuthControllerYamlTest extends AbstractIntegrationTest {
    ...
    @Test
    @Order(1)
    public void testSigninYaml() throws JsonMappingException, JsonProcessingException {
    ...
    @Test
    @Order(2)
    public void testRefreshYml() throws JsonMappingException, JsonProcessingException {
